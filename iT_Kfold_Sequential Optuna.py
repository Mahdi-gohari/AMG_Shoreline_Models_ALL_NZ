...
def main():
    ...
    plt.savefig('shoreline_prediction_optuna.png', dpi=300, bbox_inches='tight')
    plt.show()
    ...
    results.to_csv('prediction_OTAMA53_optuna.csv', index=False, float_format='%.3f')
